...
int main(int argv, char** argc)
{
    ...
    cout << "TIME" << setw(15) << "HOURS" << setw(10) << "MINUTES" << setw(11) << "SECONDS" << setw(11) << "MILITARY" << endl;

    //Output print statement
    cout << day.toString() << setw(8) << right << fixed << setprecision(3) << day.getTimeSinceMidnight(HOURS) << fixed << setprecision(0) << setw(10) << right << day.getTimeSinceMidnight(MINUTES) << setw(11) << right << day.getTimeSinceMidnight(SECONDS) << setw(11) << right << setprecision(4) << day.toMilitary() << endl; 
